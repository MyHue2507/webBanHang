...
<div class="container">
    ...
    <div class="block block-breadcrumbs">
        <ul>
            <li class="home">
                <a href="http://localhost:81/giohang/views/pages/home.php"><i class="fa fa-home"></i></a>
                <span></span>
            </li>
    ...
    <div class="category-products tab-pane fade in active " id="row_gird">
        ...
        <div style="width: 100%; background-color: white;  padding: 40px; margin-top: 10px;">
            <img src="http://localhost:81/giohang/upload/empty.jpg" style="width: 50%; margin-left:25%; margin-top: 30px;" alt="">
        </div>
        <?php } ?>
    </div>
</div>
